        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "numeric", nullable: false),
                    RequestedItems = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AidRequests_Beneficiaries_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AidRequests_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AidRequests_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalWorkflows_Users_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    DonorType = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredNotes = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AidDistributions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AidDistributions_AidRequests_AidRequestId",
                        column: x => x.AidRequestId,
                        principalTable: "AidRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AidDistributions_Users_DeliveredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AidDistributions_AidRequestId",
                table: "AidDistributions",
                column: "AidRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AidDistributions_DeliveredById",
                table: "AidDistributions",
                column: "DeliveredById");

            migrationBuilder.CreateIndex(
                name: "IX_AidRequests_BeneficiaryId",
                table: "AidRequests",
                column: "BeneficiaryId");

            migrationBuilder.CreateIndex(
                name: "IX_AidRequests_CreatedById",
                table: "AidRequests",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_AidRequests_InventoryItemId",
                table: "AidRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalWorkflows_RequestedById",
                table: "ApprovalWorkflows",
